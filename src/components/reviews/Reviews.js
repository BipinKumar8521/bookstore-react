            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="reviews">
                  <div className="slide">
                    <div className="user">
                      <img src="img/user1.jpg" alt="" className="client-image" />
                      <div className="details">
                        <span className="name">Ava Elizabeth Wilson</span>
                      </div>
                      <p>
                        "This is my go-to bookstore for all my reading needs!
              ...
              <div className="swiper-slide">
                <div className="reviews">
                  <div className="slide">
                    <div className="user">
                      <img src="img/user3.jpg" alt="" className="client-image" />
                      <div className="details">
                        <span className="name">Alexander Joseph Kim</span>
                      </div>
                      <p>
                        "I stumbled upon this bookstore website while searching
              ...
              <div className="swiper-slide">
                <div className="reviews">
                  <div className="slide">
                    <div className="user">
                      <img src="img/user2.jfif" alt="" className="client-image" />
                      <div className="details">
                        <span className="name">Sophia Isabella Thomas</span>
                      </div>
                      <p>
                        "I had a fantastic experience shopping on this bookstore
              ...
              <div className="swiper-slide">
                <div className="reviews">
                  <div className="slide">
                    <div className="user">
                      <img src="img/user4.jfif" alt="" className="client-image" />
                      <div className="details">
                        <span className="name">Noah Matthew Lee</span>
                      </div>
                      <p>
                        "I am an avid reader and have shopped at many online
